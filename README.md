...
1. Execute o script `DBMG_Create.sql` no SQL Server para criar o banco e a tabela `Tarefas`.
2. Abra o projeto `ProjetoDBMG` (console application) no Delphi.
3. Ajuste as credenciais no `connection.factory.pas` (usuário, senha ou autenticação Windows).
